...
import {RequestHandler, RequestHandlerResponse} from './apolloClient';
import {IMockSubscription, MockSubscription} from './apolloSubscription';
...
export class MockLink extends ApolloLink {
	...
	request = (operation: Operation) => {
		...
		return new Observable<FetchResult>(observer => {
			let result: Promise<RequestHandlerResponse<any>> | IMockSubscription<any> | undefined = undefined;
